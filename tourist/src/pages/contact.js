  ...
  return (
    <Main>
      ...
      <div className="container-xxl contact py-5">
        ...
        <div className="container">
          <h1 style={{ textAlign: "center", paddingTop: "50px", paddingBottom: "25px" }}>Developers</h1>

          <div className="container" id="contacts" style={{ paddingBottom: "50px" }}>
            ...
            {contacts.map((contact) => (
              ...
              >
                ...
                <h6 style={{ marginBottom: "10px" }}>รหัสนักศึกษา {contact.id}</h6>
